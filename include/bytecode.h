...
#define ARGS_MOV_IPR(GEN)	GEN(INDIRECT_PLUS) GEN(REG)
#define ARGS_MOV_ISR(GEN)	GEN(INDIRECT_SUB) GEN(REG)
#define ARGS_MOV_IC(GEN)	GEN(INDIRECT) GEN(CONST)
#define ARGS_MOV_IPC(GEN)	GEN(INDIRECT_PLUS) GEN(CONST)
#define ARGS_MOV_ISC(GEN)	GEN(INDIRECT_SUB) GEN(CONST)
